          ...
          {aiAdvice && (
            ...
            >
              <div className="lg:col-span-8 bg-gradient-to-br from-slate-900 to-slate-800 p-10 md:p-14 rounded-[3.5rem] text-white shadow-2xl relative overflow-hidden">
                ...
                <div className="relative z-10 space-y-10">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h3 className="text-2xl font-black">AIによる高度診断アドバイス</h3>
                      <p className="text-cyan-400 font-bold text-xs uppercase tracking-widest mt-1">Generated by OpenAI GPT-4o</p>
                    </div>
                  </div>
              ...
              <div className="lg:col-span-12 space-y-8">
                <div className="px-4">
                  <h3 className="text-2xl font-black text-slate-800">AIが提案する業務別アドバイス</h3>
                  <p className="text-slate-400 font-bold text-sm">個別の業務に特化したAI活用のヒントとプロンプト例</p>
                </div>
